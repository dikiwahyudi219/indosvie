...
<a href="manage-categories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi mdi-layers widget-one-icon"></i>
  ...
  <a href="unapprove-comment.php">                       
        <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Waiting Approve Comments</p>
<?php $query=mysqli_query($con,"select * from tblcomments where status=0");
$countcom=mysqli_num_rows($query);
?>
                                        <h2 style="color: red"><?php echo htmlentities($countcom);?> <small></small></h2>
 ...
 <a href="manage-message.php">                       
        <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">New Message</p>
<?php $query=mysqli_query($con,"select * from tblcontact where status=1");
$countmes=mysqli_num_rows($query);
?>
                                        <h2 style="color: red"><?php echo htmlentities($countmes);?> <small></small></h2>
