...
move_uploaded_file($_FILES["image"]["tmp_name"],"memberimages/".$imgnewfile);
        ...
        // $query = "INSERT into `tblmember` (MemberName, MemberDivision, MemberUsername, MemberPassword, MemberEmailId, Image, Is_Active) VALUES ('$nama','$divisi','$username', '".md5($password)."', '$email','$imgnewfile','$status')";
        // $result = mysqli_query($con,$query);
$query = "INSERT into `tbladmin` (AdminName, AdminDivisi, AdminUserName, AdminPassword, AdminEmailId, Image, Is_Active, Level) VALUES ('$nama','$divisi','$username', '".md5($password)."', '$email','$imgnewfile','$status','$lvl')";
        $result = mysqli_query($con,$query);
if($result)
{
$msg="user created ";
